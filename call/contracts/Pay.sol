...
//     function depositZRC20(
//         bytes32 invoiceId,
//         address zrc20Token,
//         uint256 amount
//     ) external {
//         // Use ZetaChain's universal token handling
//         address token = IZRC20(zrc20Token).nativeToken();
//         uint256 convertedAmount = IZRC20(zrc20Token).withdrawGasFee(amount);
//         IZRC20(zrc20Token).transferFrom(msg.sender, address(this), amount);
//         invoiceContract.recordPayment(invoiceId, token, convertedAmount, msg.sender);
//     }
// }
...
//         uint256 chainId
//     ) external payable {
//         bytes memory message = abi.encode(invoiceId, msg.sender, amount, targetToken);
//         gateway.send{value: msg.value}(
//             ZetaInterfaces.SendInput({
//                 destinationChainId: chainId,
//                 destinationAddress: interactors[chainId],
...
//         // Simplified implementation - in production use ZetaChain's swap logic
//         out = amount;
//         gasZRC20 = address(0);
//         gasFee = 0;
//     }
...
//         uint256 out
//     ) internal {
//         IERC20(params.targetToken).transfer(params.recipient, out);
//     }

//     function _handleFailedSwap(RevertContext calldata context) internal {}
